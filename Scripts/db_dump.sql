...
--
-- Host: craveoncampus.chsvosjncpze.us-east-2.rds.amazonaws.com    Database: Campus_Eats_Fall2020
-- ------------------------------------------------------
...
CREATE TABLE `DriverRatingTable` (
  ...
  KEY `driver_rating_index` (`Driver_ID`),
  CONSTRAINT `DriverRatingTable_ibfk_1` FOREIGN KEY (`Driver_ID`) REFERENCES `driver` (`driver_id`)
...
/*!40000 ALTER TABLE `DriverRatingTable` DISABLE KEYS */;
INSERT INTO `DriverRatingTable` VALUES (1,2,2),(2,5,3),(3,5,2),(4,3,5),(5,3,1),(6,5,4),(7,2,4),(8,7,3),(9,3,3),(10,3,5),(11,7,2),(12,3,2),(13,7,4),(14,4,1),(15,3,4),(16,1,4),(17,3,2),(18,4,3),(19,7,3),(20,3,4),(21,8,2),(22,8,2),(23,2,3),(24,5,2),(25,6,4),(26,3,3),(27,5,1),(28,2,1),(29,6,2),(30,2,2),(31,2,2),(32,2,4),(33,7,3),(34,4,1),(35,7,1),(36,2,3),(37,2,2),(38,4,2),(39,2,5),(40,5,5),(41,6,4),(42,5,2),(43,3,3),(44,6,2),(45,8,4),(46,1,4),(47,4,4),(48,5,1),(49,7,1),(50,3,4),(51,3,2),(52,6,2),(53,7,2),(54,3,4),(55,1,3),(56,8,3),(57,2,4),(58,6,1),(59,5,1),(60,4,5),(61,8,3),(62,6,2),(63,7,4),(64,6,2),(65,5,4),(66,3,3),(67,6,4),(68,3,3),(69,2,3),(70,4,4),(71,2,3),(72,3,1),(73,1,3),(74,1,1),(75,8,4),(76,6,3),(77,2,2),(78,5,1),(79,7,4),(80,5,1),(81,4,4),(82,2,4),(83,7,3),(84,4,2),(85,3,2),(86,1,2),(87,2,3),(88,3,2),(89,4,1),(90,2,2),(91,4,4),(92,3,4),(93,5,4),(94,3,3),(95,1,2),(96,3,3),(97,5,5),(98,2,3),(99,1,3),(100,7,2);
/*!40000 ALTER TABLE `DriverRatingTable` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `RestaurantRatingTable` (
  `RestaurantRating_ID` int NOT NULL,
  `Restaurant_ID` int DEFAULT NULL,
  `Rating` int DEFAULT NULL,
  PRIMARY KEY (`RestaurantRating_ID`),
  KEY `restaurant_rating_index` (`Restaurant_ID`),
  CONSTRAINT `RestaurantRatingTable_ibfk_1` FOREIGN KEY (`Restaurant_ID`) REFERENCES `restaurant` (`Restaurant_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `RestaurantRatingTable` DISABLE KEYS */;
INSERT INTO `RestaurantRatingTable` VALUES (1,1,4),(2,2,4),(3,3,2),(4,4,5),(5,5,2),(6,6,2),(7,7,2),(8,8,1),(9,9,3),(10,10,3),(11,11,2),(12,12,4),(13,13,2),(14,14,4),(15,15,5),(16,16,3),(17,17,5),(18,18,4),(19,19,5),(20,20,4),(21,21,3),(22,22,2),(23,23,5),(24,24,2),(25,25,2),(26,26,4),(27,27,2),(28,28,2),(29,29,1),(30,30,3),(31,31,3),(32,32,4),(33,33,2),(34,34,3),(35,35,2),(36,36,2),(37,37,3),(38,38,2),(39,39,4),(40,40,2),(41,41,4),(42,42,3),(43,43,4),(44,44,3),(45,45,5),(46,46,3),(47,47,3),(48,48,5),(49,49,2),(50,50,5),(51,51,2),(52,52,4),(53,53,4),(54,54,3),(55,55,3),(56,56,3),(57,57,4),(58,58,2),(59,59,4),(60,60,2),(61,61,4),(62,62,4),(63,63,3),(64,64,4),(65,65,2),(66,66,4),(67,67,4),(68,68,5),(69,69,5),(70,70,3),(71,71,3),(72,72,3),(73,73,1),(74,74,2),(75,75,4),(76,76,3),(77,77,4),(78,78,4),(79,79,2),(80,80,1),(81,81,3),(82,82,4),(83,83,4),(84,84,5),(85,85,1),(86,86,2),(87,87,4),(88,88,4),(89,89,2),(90,90,3),(91,91,5),(92,92,4),(93,93,2),(94,94,3),(95,95,5),(96,96,3),(97,97,4),(98,98,3),(99,99,5),(100,100,3);
/*!40000 ALTER TABLE `RestaurantRatingTable` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `best_restaurants_view`
--

DROP TABLE IF EXISTS `best_restaurants_view`;
/*!50001 DROP VIEW IF EXISTS `best_restaurants_view`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `best_restaurants_view` AS SELECT 
 1 AS `restaurant_id`,
 1 AS `max_price`,
 1 AS `avg_rating`*/;
...
CREATE TABLE `delivery` (
  ...
  KEY `delivery_index` (`delivery_id`,`driver_id`,`vehicle_id`),
...
CREATE TABLE `driver` (
  ...
  KEY `driver_index` (`driver_id`,`student_id`),
...
CREATE TABLE `faculty` (
  ...
  KEY `faculty_index` (`person_id`,`title`),
...
CREATE TABLE `location` (
  ...
  KEY `location_index` (`location_id`,`location_name`)
...
--
-- Temporary view structure for view `most_expensive_restaurants`
--

DROP TABLE IF EXISTS `most_expensive_restaurants`;
/*!50001 DROP VIEW IF EXISTS `most_expensive_restaurants`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `most_expensive_restaurants` AS SELECT 
 1 AS `restaurant_id`,
...
CREATE TABLE `order` (
  ...
  KEY `order_index` (`order_id`,`person_id`,`delivery_id`,`location_id`,`driver_id`,`restaurant_id`),
...
CREATE TABLE `person` (
  ...
  KEY `person_index` (`person_id`,`person_name`)
...
CREATE TABLE `restaurant` (
  ...
  KEY `restaurant_index` (`restaurant_id`,`restaurant_name`)
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Temporary view structure for view `restaurant_order_summary`
--

DROP TABLE IF EXISTS `restaurant_order_summary`;
/*!50001 DROP VIEW IF EXISTS `restaurant_order_summary`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `restaurant_order_summary` AS SELECT 
 1 AS `restaurant_id`,
 1 AS `avg_delivery_charge`,
 1 AS `total_price`,
 1 AS `number_of_orders`,
 1 AS `Avg_Restaurant_Rating`,
 1 AS `Avg_Driver_Rating`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `restaurants_with_exceptional_drivers`
--

DROP TABLE IF EXISTS `restaurants_with_exceptional_drivers`;
/*!50001 DROP VIEW IF EXISTS `restaurants_with_exceptional_drivers`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `restaurants_with_exceptional_drivers` AS SELECT 
 1 AS `restaurant_name`,
 1 AS `location`,
 1 AS `avg_delivery_charge`*/;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `staff` (
  ...
  KEY `staff_index` (`staff_id`,`person_id`),
  CONSTRAINT `fk_S_person_id` FOREIGN KEY (`person_id`) REFERENCES `person` (`person_id`),
  CONSTRAINT `check_is_admin_y_n` CHECK ((`is_admin` in (_latin1'Y',_latin1'N')))
...
CREATE TABLE `student` (
  ...
  KEY `student_index` (`student_id`,`person_id`),
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `get_restaurant_id`(restaurant_name_var VARCHAR(100)) RETURNS int
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `average_driver_ratings` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `average_driver_ratings`(
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `average_restaurant_ratings` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `average_restaurant_ratings`(
...
--
-- Final view structure for view `best_restaurants_view`
--
...
/*!50001 VIEW `best_restaurants_view` AS with `get_restaurants` as (select `r`.`restaurant_id` AS `restaurant_id`,`o`.`total_price` AS `total_price`,`rt`.`Rating` AS `rating` from ((`restaurant` `r` join `order` `o` on((`r`.`restaurant_id` = `o`.`restaurant_id`))) join `RestaurantRatingTable` `rt` on((`r`.`restaurant_id` = `rt`.`Restaurant_ID`))) order by `r`.`restaurant_id`) select `restaurant`.`restaurant_id` AS `restaurant_id`,max(`restaurant`.`total_price`) AS `max_price`,avg(`restaurant`.`rating`) AS `avg_rating` from `get_restaurants` `restaurant` where (`restaurant`.`rating` > 0) group by `restaurant`.`restaurant_id` order by `restaurant`.`rating` desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `most_expensive_restaurants`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `most_expensive_restaurants` AS select `r`.`restaurant_id` AS `restaurant_id`,`r`.`restaurant_name` AS `restaurant_name`,`o`.`total_price` AS `total_price`,rank() OVER (ORDER BY `o`.`total_price` desc )  AS `Rank_Num` from (`restaurant` `r` join `order` `o` on((`r`.`restaurant_id` = `o`.`restaurant_id`))) group by `r`.`restaurant_id`,`o`.`total_price` order by `Rank_Num` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `restaurant_order_summary`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `restaurant_order_summary` AS select `o`.`restaurant_id` AS `restaurant_id`,round(avg(`o`.`delivery_charge`),2) AS `avg_delivery_charge`,round(`o`.`total_price`,2) AS `total_price`,count(`o`.`order_id`) AS `number_of_orders`,avg(`r`.`Rating`) AS `Avg_Restaurant_Rating`,avg(`d`.`Rating`) AS `Avg_Driver_Rating` from ((`order` `o` join `RestaurantRatingTable` `r` on((`o`.`restaurant_id` = `r`.`Restaurant_ID`))) join `DriverRatingTable` `d` on((`o`.`driver_id` = `d`.`Driver_ID`))) group by `r`.`Restaurant_ID` order by `r`.`Restaurant_ID` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `restaurants_with_exceptional_drivers`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `restaurants_with_exceptional_drivers` AS select `r`.`restaurant_name` AS `restaurant_name`,`r`.`location` AS `location`,round(avg(`o`.`delivery_charge`),2) AS `avg_delivery_charge` from ((`order` `o` join `restaurant` `r` on((`o`.`restaurant_id` = `r`.`restaurant_id`))) join `RestaurantRatingTable` `rrt` on((`r`.`restaurant_id` = `rrt`.`Restaurant_ID`))) where exists(select `drt`.`Driver_ID` from `DriverRatingTable` `drt` where ((`drt`.`Rating` >= 4) and (`drt`.`Driver_ID` = `o`.`driver_id`))) group by `r`.`restaurant_name`,`r`.`location` order by `r`.`restaurant_name`,`r`.`location` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2021-12-06 22:06:44
